...
// Save output as JSON file (for backward compatibility)
const outputPath = './dist/completion-docs.json';
fs.writeFileSync(outputPath, JSON.stringify(completionDocs, null, 2));
...
console.info(`Completion docs generated successfully (${outputPath})`);
